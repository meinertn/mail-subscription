...
class DataSource
{
    ...
    const DATABASENAME = 'double_opt_in';
    ...
    public function insert($query, $paramType, $paramArray)
    {
        ...
        if ($stmt->execute()) {
            $result = $this->supportService->createJsonInstance('Inserted successfully.', 'message');
        } else {
            $result = $this->supportService->createJsonInstance($stmt->error);
        }
        return $result;
    }
